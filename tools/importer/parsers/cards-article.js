 ...
 * Base block: cards
 * Source: https://wknd.site/us/en.html (main.cmp-layout-container--fixed:nth-of-type(1) div.image-list.list)
...
export default function parse(element, { document }) {
  // Each article card is a list item in the WKND image list.
